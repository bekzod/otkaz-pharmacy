(function () {
  ...
  const translations = {
    ru: {
      ...
      'row.commentPrompt': 'Комментарий для «{label}»',
      'row.commentPlaceholder': 'Введите комментарий…',
      ...
      'row.unresolveButton': '❌ Отменить решение',
      'row.resolved': 'Решено',
    ...
    'uz-Cyrl': {
      ...
      'row.commentPrompt': '«{label}» учун изоҳ',
      'row.commentPlaceholder': 'Изоҳ киритинг…',
      'row.commentSaved': '«{label}» учун изоҳ сақланди.',
      'row.commentRemoved': '«{label}» учун изоҳ ўчирилди.',
      'modal.save': 'Сақлаш',
      'modal.cancel': 'Бекор қилиш',
      'modal.delete': 'Ўчириш',
      'row.resolveButton': '✅ Ҳал қилинган деб белгилаш',
      'row.unresolveButton': '❌ Ҳал қилинишни бекор қилиш',
    ...
    'uz-Latn': {
      ...
      'row.commentPrompt': '«{label}» uchun izoh',
      'row.commentPlaceholder': 'Izoh kiriting…',
      ...
      'row.unresolveButton': '❌ Hal qilinishni bekor qilish',
